    ...
    <Section className="overflow-hidden" id="pricing">
      <div className="container relative z-2">
        <div className="hidden relative justify-center mb-[6.5rem] lg:flex">
          ...
          <div className="absolute top-1/2 left-1/2 w-[60rem] -translate-x-1/2 -translate-y-1/2 point-events-none">
            <img src={stars} className="w-full" alt="Stars" width={950} height={400} />
          </div>
        </div>
