    ...
    <Section crosses>
      <div className='container lg:flex'>
        <div className="max-w-[25rem]">
          <h2 className="h2 mb-4 md:mb-8">AI Chat App from seamless collaboration</h2>
        ...
        <div className="lg:ml-auto xl:w-[38rem] mt-8">
          <p className="body-2 mb-4 text-n-4 md:mb-16 lg:mb-32 lg:w-[22rem] lg:mx-auto max-md:mb-16">{collabText}</p>
